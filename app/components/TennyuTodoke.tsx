    ...
    return (
        <div
            ...
            style={{
                ...
                isolation: 'isolate', // Prevent style leakage from parents
            }}
        >
            {/* STAMP & TEXTURE STYLES */}
            <style>{`
                .stamp-texture {
            ...
            <div className="absolute top-4 left-4 right-4 bottom-4 border-[3px] border-[#2d2418] border-solid pointer-events-none z-0 opacity-90 shadow-sm" />
            ...
            {/* --- Block 1: Header (Absolute Center Title) --- */}
            <header className="relative z-10 w-full mb-2">
                {/* Mascot Frame - Pinned to absolute corner */}
                ...
                {/* Centered Title Content - Independent of Mascot */}
                ...
                {/* Metadata Row - Structured Below Title */}
            ...
            <main className="relative z-10 flex-grow flex gap-12 py-1 overflow-hidden font-medium">
                ...
                {/* Profile Fields - REBUILT WITHOUT BORDERS */}
                <div className="flex-1 flex flex-col justify-between py-2">
                    ...
                    <div className="relative pb-1">
                        <span className="text-[11px] font-black tracking-widest text-[#c9a64e] flex items-center gap-2 mb-1">
                            <span className="w-2 h-2 rounded-full border border-solid border-[#c9a64e]/50 bg-[#c9a64e]/20"></span> 自由記載
                        </span>
            ...
            <footer className="relative z-10 w-full pt-4 min-h-[90px]">
                <div className="flex justify-between items-end">
                    ...
                    <div className="absolute -top-12 -right-4 w-48 h-48 pointer-events-none select-none z-10">
                        <div className="w-full h-full rounded-full flex items-center justify-center font-black stamp-texture transform -rotate-[12deg] border-[4.5px] border-double border-solid" 
                             style={{ 
                                 borderColor: 'rgba(168, 64, 50, 0.55)', 
