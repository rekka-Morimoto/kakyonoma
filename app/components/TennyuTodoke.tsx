        ...
        >
            ...
            <header className="relative z-10 w-full mb-4">
                <div className="text-center mb-4">
                    ...
                    <h1 className="text-4xl font-black tracking-[0.8em] whitespace-nowrap text-[#2d2418] mr-[-0.8em] font-serif">入居届</h1>
            ...
            <main className="relative z-10 flex-grow flex gap-12 py-2 overflow-hidden">
                {/* Photo Column */}
                <div className="w-[155px] shrink-0 pt-2">
                ...
                <div className="flex-1 flex flex-col justify-center gap-6">
                    ...
                    <div className="relative">
                        ...
                        <div className="text-2xl pl-4 font-black h-9 flex items-center text-[#2d2418]">
                           {name || ''}
                        </div>
                        <div className="w-full h-[2.5px] bg-[#2d2418] rounded-full" />
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="text-lg pl-6 font-bold h-7 flex items-center text-[#2d2418]">
                           {nickname || ''}
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-8 mt-2">
                        <div className="relative">
                            ...
                            <div className="text-xl pl-4 font-black h-8 flex items-end text-[#a84032] italic">
                        ...
                        <div className="relative">
                            ...
                            <div className="text-base pl-4 font-bold h-8 flex items-end text-[#2d2418] truncate">
                               {baseLocation || ''}
                            </div>
                            <div className="w-full h-[1px] bg-[#2d2418]/10 mt-1" />
                        </div>
            ...
            {/* --- Block 3: Footer (Signature, SNS, Stamp) --- */}
            <footer className="relative z-10 w-full pt-4 h-32 flex flex-col justify-end">
                <div className="flex justify-between items-end">
                    {/* Left: Signature area */}
                    <div className="pb-1 max-w-[420px]">
                        <div className="flex items-center gap-4 mb-3 opacity-20">
                    ...
                    {/* Right: Info and SNS */}
                    <div className="flex flex-col items-end gap-3 pr-24">
                        ...
                        <div className="flex gap-2 mr-2">
                            <div className="w-7 h-7 rounded-lg bg-[#2d2418] flex items-center justify-center text-white text-[10px] font-black shadow-sm">X</div>
                            <div className="w-7 h-7 rounded-lg bg-[#a84032] flex items-center justify-center text-white text-[8px] font-black shadow-sm">Yt</div>
                        </div>
                    </div>
                </div>

                {/* Fixed position Stamp - constrained relative to footer to avoid collision */}
                <div className="absolute -top-4 right-8 w-32 h-32 pointer-events-none select-none z-20">
